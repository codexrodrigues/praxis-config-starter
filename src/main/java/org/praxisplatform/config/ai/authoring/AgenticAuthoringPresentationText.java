...
public final class AgenticAuthoringPresentationText {
    ...
    public static String display(String value) {
        ...
        return text
                ...
                .replace("Funcionarios", "Funcionários")
                .replace(" informacoes", " informações")
                .replace("Informacoes", "Informações")
                .replace(" intencao", " intenção")
                .replace("Intencao", "Intenção")
                .replace(" decisao", " decisão")
                .replace("Decisao", "Decisão")
                .replace(" evidencia", " evidência")
                .replace("Evidencia", "Evidência")
                .replace(" evidencias", " evidências")
                .replace("Evidencias", "Evidências")
                .replace(" disponiveis", " disponíveis")
                .replace("Disponiveis", "Disponíveis")
                .replace(" disponivel", " disponível")
                .replace("Disponivel", "Disponível")
                .replace(" revisao", " revisão")
                .replace("Revisao", "Revisão")
                .replace(" restricoes", " restrições")
                .replace("Restricoes", "Restrições")
                .replace(" pre-visualizacao", " pré-visualização")
                .replace("Pre-visualizacao", "Pré-visualização")
                .replace(" materializacao", " materialização")
                .replace("Materializacao", "Materialização")
                .replace(" visualizacao", " visualização")
                .replace("Visualizacao", "Visualização")
                .replace(" validacao", " validação")
                .replace("Validacao", "Validação")
                .replace(" Proximo", " Próximo")
                .replace(" proximo", " próximo")
                .replace(" semantica", " semântica")
                .replace("Semantica", "Semântica")
                ...
                .replace(" voce ", " você ")
                .replace("Voce ", "Você ")
                .replaceAll("(?iu)(?<!\\p{L})pagina(?!\\p{L})", "página")
