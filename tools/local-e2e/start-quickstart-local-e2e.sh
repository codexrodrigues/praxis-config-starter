...
export APP_SECURITY_CONFIG_ORIGIN_RESTRICTION_ALLOWED_ORIGINS="${APP_SECURITY_CONFIG_ORIGIN_RESTRICTION_ALLOWED_ORIGINS:-http://localhost:4003,http://127.0.0.1:4003}"
export CORS_ALLOWED_ORIGINS="${CORS_ALLOWED_ORIGINS:-http://localhost:4003,http://127.0.0.1:4003}"
