...
AI_TIMEOUT_SECONDS_OVERRIDE="${AI_TIMEOUT_SECONDS:-${PRAXIS_AI_TIMEOUT_SECONDS:-}}"
...
export PRAXIS_AI_REGISTRY_BOOTSTRAP_FORCE="${PRAXIS_AI_REGISTRY_BOOTSTRAP_FORCE:-false}"
export PRAXIS_AI_REGISTRY_BOOTSTRAP_REFRESH_ON_SNAPSHOT_DRIFT="${PRAXIS_AI_REGISTRY_BOOTSTRAP_REFRESH_ON_SNAPSHOT_DRIFT:-false}"
export PRAXIS_AI_STREAM_PROCESSING_TIMEOUT_SECONDS="$STREAM_TIMEOUT_SECONDS"
if [[ -n "$AI_TIMEOUT_SECONDS_OVERRIDE" ]]; then
  export PRAXIS_AI_TIMEOUT_SECONDS="$AI_TIMEOUT_SECONDS_OVERRIDE"
fi
