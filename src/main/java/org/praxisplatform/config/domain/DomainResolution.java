...
/**
 * Semantic resolution between context-local concepts and terms.
 */
@Entity
...
public class DomainResolution {
  ...
  @Column(name = "resolution_key", nullable = false, length = 768)
  private String resolutionKey;

  @Column(name = "source_concept_key", nullable = false, length = 512)
  private String sourceConceptKey;

  @Column(name = "target_concept_key", nullable = false, length = 512)
  private String targetConceptKey;
  ...
  @Column(name = "resolution_type", nullable = false, length = 64)
