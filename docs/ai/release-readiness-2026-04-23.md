...
- The current Domain Federation v0.1 path now persists governed candidate releases and supports explicit activation, but query-time federation should still prefer reviewed active releases only.
