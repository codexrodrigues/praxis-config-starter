...
class AiApiContractOpenApiTest {
    ...
    void shouldLoadAndValidateAiOpenApiContract() throws IOException {
        ...
        assertThat(paths).containsKeys(
                ...
                "/api/praxis/config/ai/triage/observations",
                "/api/praxis/config/ai/triage/observations/{observationId}",
                "/api/praxis/config/ai/triage/summary",
                "/api/praxis/config/ai/triage/observations/{observationId}/feedback",
        ...
        assertThat(schemas).containsKeys(
                ...
                "AiAssistantObservationResponse",
                "AiAssistantObservationFeedbackRequest",
                "AiAssistantObservationFeedbackResponse",
                "AiAssistantObservationSummaryResponse",
