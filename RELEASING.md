...
- confirma que o plano intermediario nao inventa campos fora do recurso governado e que o preview schema-grounded preserva os campos obrigatorios `descricao` e `ocorridoEm`, rejeitando campos inexistentes como `titulo`;
